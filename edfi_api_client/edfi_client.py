...
class EdFiClient:
    ...
    def __init__(self,
        ...
        *,
        ...
        self.persisted_token_base_path = persisted_token_base_path
        ...
        self.session = EdFiSession(oauth_url, self.client_key, self.client_secret, self.use_persisted_token, self.persisted_token_base_path)
